...
export default function FaqPage() {
    return (
        <div className='w-full flex items-start justify-center text-white bg-fill'>
            ...
            <div className='bg-secondary pl-5 pr-20 pt-40 py-20 text-left items-start justify-start flex min-h-full flex-col w-auto border-l border-pred'>
