...
export default function HeroSection() {
    return (
        <section className="text-text px-8 md:px-16 lg:px-32 py-16 flex flex-col gap-52 relative">
            ...
            <h2 className="text-4xl md:text-6xl font-bold text-right leading-tight">
