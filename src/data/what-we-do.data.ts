export const WEDO = [
    {
        id: 1,
        icon: "🎯",
        titleOne: "Strategic Growth",
        titleTwo: "Content Mastery",
        body: "Standing out is tough—only 2.5% of YouTubers reach 1,000 subscribers. Our expert strategists craft the perfect game plan to elevate your channel above the noise.",
    },
    {
        id: 2,
        icon: "🖼️",
    ...
    },
    {
        id: 7,
        icon: "✍️",
        titleOne: "Script Ideas",
        titleTwo: "Story-Driven Writing",
        body: "From quick outlines to fully structured scripts, we design content tailored to any format—shorts, long-form & everything in between."
    },
    {
        id: 8,
        icon: "🚀",
